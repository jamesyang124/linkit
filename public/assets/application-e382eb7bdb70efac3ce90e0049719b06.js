...
function genElement(data){
  ...
  var poster_box = '<div class="chat"><div class="chatbox"><img alt="" class="img-circle" src="' + (data.poster_image != null ? data.poster_image : "/assets/u40.png") + '"><b id="cname">' + data.poster + '</b><br> via  <b>' + data.provider_name + '</b> on <b>' + data.created_at + '</b></div>';
  
  var comments = "";
  for (var i = 0; i < data.comments.length; i++){
    comments += '<div class="chatbox"><img alt="" class="img-circle" src="' + (data.comments[i].commenter_image != null ? data.comments[i].commenter_image : "/assets/u40.png") + '"><b id="cname">' + data.comments[i].commenter + '</b><p>'+ data.comments[i].comment +'</p></div>';
  }
